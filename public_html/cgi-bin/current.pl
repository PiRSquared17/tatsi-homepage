...
sub InitVariables {  # Init global session variables for mod_perl!
  $WikiDescription = $q->p($q->a({-href=>'http://git.savannah.gnu.org/cgit/oddmuse.git/tag/?id=2.2.4-31-g1e73ae2'}, 'wiki.pl') . ' (2.2.4-31-g1e73ae2), see ' . $q->a({-href=>'http://www.oddmuse.org/'}, 'Oddmuse'),
